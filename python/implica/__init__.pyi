...
class TypeSchema:
    ...
    def matches(self, type: Type, context: Context = {}) -> bool: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
...
class TermSchema:
    ...
    def __init__(self, pattern: str) -> None: ...
    def matches(self, term: Term, context: Context = {}) -> bool: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
...
class NodePattern:
    ...
    def matches(self, node, context: Context = {}) -> bool: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
...
class EdgePattern:
    ...
    def matches(self, edge, context: Context = {}) -> bool: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
